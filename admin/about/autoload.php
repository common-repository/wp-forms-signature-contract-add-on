...
function wpforms_message($esigStatus,$pluginName)
        {
            ...
            switch ($esigStatus){
                ...
                case 'wpe_inactive':
                  ...
                  break;
                case 'wpe_expired':
                  return '<span class="esig-icon-esig-alert"></span><h4>' . esc_attr($asterisk) . 'You willl need to activate your WP E-Signature license to run the WPForms Signature add-on.  <a class="about-button" href="admin.php?page=esign-licenses-general">Enter your license here</a> </h4>';
                  break;
                ...
                case 'wpe_active_pro':
                  ...
                  if (!function_exists('wpforms')) {// Notice about add-on dependent 3rd party plugin if not installed
                   return '<span class="esig-icon-esig-alert"></span><h4>The WPForms plugin is not installed. Please install WPForms  version 1.4.0 or greater - <a href="https://wordpress.org/plugins/wpforms-lite/">Get it here now</a></h4>';
                  }
                  elseif(!class_exists('ESIG_SAD_Admin')){// Notice about stand alone documents if not enabled
                    return '<span class="esig-icon-esig-alert"></span><h4>WP E-Signature <a href="https://www.approveme.com/wpesign-features/stand-alone-documents/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms" target="_blank">"Stand Alone Documents"</a> Add-on is not active. Please enable WP E-Signature Stand Alone Documents  <a class="about-button" href="'. admin_url("admin.php?page=esign-addons&tab=disable&esig_action=enable&plugin_url=esig-stand-alone-docs%2Fesig-sad.php&plugin_name=WP%20E-Signature%20-%20Stand%20Alone%20Documents") .'">Enable it now </a> </h4>';
                  }

                  break;
                case 'no_wpe':
                    return '<span class="esig-icon-esig-alert"></span> <h4>' . esc_attr($asterisk) . 'WP E-Signature is not installed. It is required to run the WPForms Signature add-on. &nbsp; <span class="button-container"><a class="about-button" href="https://www.approveme.com/wpforms-signature-special/?utm_campaign=wprepo&">Get your WP E-Signature license</a></span></h4>';
                    break;
                default:
                  return false;
                  break;
