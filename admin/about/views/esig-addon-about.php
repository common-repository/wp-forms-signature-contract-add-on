...
$steps = esig_load_template(__DIR__ . '/wpforms-esign-about-steps');

$about_options = array(
    'pluginName'        => 'WPForms',
    'setupVidImage'     => plugins_url('../assets/images/getting-started-video-thumb.jpg', __FILE__),
    'setupVidURL'       => 'https://www.youtube.com/embed/ih0C9W4ql0I?&autoplay=1&rel=0&theme=light&hd=1&autohide=1&showinfo=0&color=white&showinfo=0?TB_iframe=true&width=700&height=540',
    'stepContent'       => $steps
);
