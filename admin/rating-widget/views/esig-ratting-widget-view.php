...
<div id="esign-wpform-ratting" class="postbox esign_ratting_section">
	...
	<div class="inside">
		<div class="esign_wpform_ratting_widget_info">
		...
		<div class="col-sm-1 esign_wpform_ratting_widget_yes"><input type="submit" id="esig-wpform-action-ratting-widget" class="button action esign_wpform_ratting_widget_yes_button" value="Yes"></div>
    	<div class="col-sm-4 esign_wpform_ratting_widget_no"><a class="esign_ratting_widget_no_button" href="#">Not Really</a></div>
