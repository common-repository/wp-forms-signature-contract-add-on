...
<!--[if lt IE 9]><script>document.createElement('audio');document.createElement('video');</script><![endif]-->
        <div class="wrap approveme-about-wrap">
            ...
            <h1>Get Started with WPForms &amp; WPESign by ApproveMe</h1>



            <div class="about-text top">Automatically collect digital signatures on contracts, after your visitors submit a form using ApproveMe's WP E-Signature. <a href="https://www.approveme.com/ueta-and-esign-act/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms">UETA/ESIGN Compliant</a> legally binding contracts with WordPress.

                <br>
            </div>

            <div align="center"> <div class="approveme-btn"><a class="approveme-demo-link" href="http://www.secure.approveme.com/demo/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms">Try a Live Demo of this Integration</a></div></div>
            ...
            <div id="esig-yt-video">
                <p align="center">
                    ...
                    <a href="//www.youtube.com/embed/ih0C9W4ql0I?&autoplay=1&rel=0&theme=light&hd=1&autohide=1&showiwpformo=0&color=white&showiwpformo=0?TB_iframe=true&width=960&height=540" class="thickbox">
            ...
            <div class="approveme-cta">
                ...
                <a href="https://www.approveme.com/wpforms-special-pricing/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms" class="hvr-float-shadow">Get My ApproveMe Plugin</a>
            </div>
            ...
            <div class="changelog feature-list">
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            ...
                            <p><a href="https://wordpress.org/plugins/wpform-forms/">1. WPForms</a><br> <a href="https://www.approveme.com/wpforms-special-pricing/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms">2. WP E-Signature</a> <em>(ultimate, elite or plus license)<br> </em><a href="https://www.approveme.com/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms">3. E-Signature Advanced Add-Ons</a> <em>(included with the license above)<br> </em></p>
                        </div>
                ...
                <div class="approveme-feature-section">
                    <div class="approveme-row">
                        ...
                        <div class="approveme-column-2">
                            ...
                            <p>Once you have purchased a ultimate, business or plus license from ApproveMe you will need to <a href="admin.php?page=esign-licenses-general">enter your license key</a> to activate updates and support.</p>
                            <p>To download your license key you can log into your <a href="https://www.approveme.com/purchase-history">ApproveMe account here</a> (password was emailed with your receipt)</p>
                        </div>
                    </div>
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            ...
                            <div class="approveme-btn">  <p class="esig-mini-btn"><a href="post-new.php?post_type=page" class="approveme-mini-btn" target="_blank">Create a Blank Page Now</a></p></div>
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        ...
                        <div class="approveme-column-2">
                            ...
                            <p>To learn more about Stand Alone Documents checkout the <a href="https://wpe.approveme.com/article/137-stand-alone-documents-add-on?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms">documentation page</a> for this add-on.</p>
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            ...
                            <p><strong>How to add form fields data into a contract using WPForms</strong><br><ol><li>Navigate to the Signer Input Fields/Custom Fields icon and select "WPForms Data".</li>


                                <li>Select the WPForms that you have already created (and would like to connect to your contract) using the dropdown menu.</li><li>Choose the field data that you would like to insert into your new contract.</li></ol></p>
                    ...
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            ...
                            <p>Click <strong style="color: #fff;
                                             ...
                                             font-weight: 400;">Let's Go Now!</strong> to define those last WPForms settings.</p>
                        </div>
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        ...
                        <div class="approveme-column-2">
                            ...
                            <div align="center"> <div class="approveme-btn"><a class="approveme-demo-link" href="http://www.secure.approveme.com/demo/?utm_source=wprepo&utm_medium=link&utm_campaign=wpforms" class="esig-mini-btn" target="_blank">Try Free WPForms + WP E-Signature Demo Here</a></div></div>
                            <br>
                        </div>
                    </div>
                </div>
                ...
                <h2>Still got questions? Login to your account at <br> <a href="https://www.approveme.com/sign-in/">www.approveme.com</a></h2>
            </div>
        </div>
...
<div id="approveme-iframe-wrapper">
    ...
    <iframe name="approveme-snify" src="https://www.approveme.com/apps/snip/?name=WPForms" id="approve-me-bar" style="width: 889px; opacity: 1;
